...
- (NSString *)initialViewControllerH
{
    ...
    NSString *initialViewController = [NSString stringWithFormat:
        ...
        @"\n"
        @"+ (UIViewController *)initializeInitialViewControllerFrom%@;\n"
        @"\n"
        @"@end\n"
        @"\n",
...
- (NSString *)segueForControllerH:(SSGController *)controller
{
    ...
    NSString *segueTypedef = [NSString stringWithFormat:
        @"extern const struct %@\n"
        @"{\n"
        @"%@\n"
        @"} %@;\n",
        controllerSegueType, [segueLines componentsJoinedByString:@"\n"], controllerSegueType];

    NSString *category = [NSString stringWithFormat:
        @"\n"
        @"@interface %@ (StoryboardSegue)\n"
        @"\n"
        @"@property (nonatomic, assign, readonly) struct %@ segue;\n"
        @"\n"
        @"+ (struct %@)segue;\n"
        @"\n"
        @"@end\n"
        @"\n",
        [self controllerClass:controller], controllerSegueType, controllerSegueType];
...
- (NSString *)cellForControllerH:(SSGController *)controller
{
    ...
    NSString *segueTypedef = [NSString stringWithFormat:
        ...
        @"%@\n"
        @"} %@;\n",
        controllerCellType, [cellLines componentsJoinedByString:@"\n"], controllerCellType];

    NSString *category = [NSString stringWithFormat:
        @"\n"
        @"@interface %@ (StoryboardCell)\n"
        @"\n"
        @"@property (nonatomic, assign, readonly) struct %@ cell;\n"
        @"\n"
        @"+ (struct %@)cell;\n"
        @"\n"
        @"@end\n"
        @"\n",
        [self controllerClass:controller], controllerCellType, controllerCellType];
...
- (NSString *)constructorsForControllerH:(SSGController *)controller
{
    ...
    return [NSString stringWithFormat:
        ...
        @"@end\n"
        @"\n",
        [self controllerClass:controller], storyboardName, [constructors componentsJoinedByString:@"\n"]];
}
...
- (NSError *)writeH:(NSString *)file
{
    ...
    [controllers addObject:@"#import <UIKit/UIKit.h>\n"];
...
- (NSString *)segueForControllerM:(SSGController *)controller
{
    ...
    NSString *segueTypedef = [NSString stringWithFormat:
        ...
        @"%@\n"
        @"};\n",
        controllerSegueType, controllerSegueType, [segueLines componentsJoinedByString:@"\n"]];
    ...
    NSString *category = [NSString stringWithFormat:
        ...
        @"@end\n"
        @"\n",
        [self controllerClass:controller], controllerSegueType, controllerSegueType, controllerSegueType];
...
- (NSString *)cellForControllerM:(SSGController *)controller
{
    ...
    NSString *cellTypedef = [NSString stringWithFormat:
        @"const struct %@ %@ = {\n"
        @"%@\n"
        @"};\n",
        controllerCellType, controllerCellType, [cellLines componentsJoinedByString:@"\n"]];
    ...
    NSString *category = [NSString stringWithFormat:
        ...
        @"@end\n"
        @"\n",
        [self controllerClass:controller], controllerCellType, controllerCellType, controllerCellType];
...
- (NSString *)constructorsForControllerM:(SSGController *)controller
{
    ...
    NSMutableArray *constructors = [NSMutableArray arrayWithCapacity:controller.storyboardIdentifiers.count];
    for (NSString *storyboardIdentifier in controller.storyboardIdentifiers) {
        [constructors addObject:[NSString stringWithFormat:
            @"+ (instancetype)controller%@\n"
            @"{\n"
            @"    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@\"%@\" bundle:nil];\n"
            @"    return [storyboard instantiateViewControllerWithIdentifier:@\"%@\"];\n"
            @"}\n",
            storyboardIdentifier, storyboardName, storyboardIdentifier]];
    }
